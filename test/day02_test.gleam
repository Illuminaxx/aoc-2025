...
pub fn is_invalid_part1_123123_test() {
  day02.is_invalid_id_part1(123_123)
  |> should.be_true()
}
...
pub fn is_invalid_part2_12341234_test() {
  day02.is_invalid_id_part2(12_341_234)
  |> should.be_true()
}

pub fn is_invalid_part2_123123123_test() {
  day02.is_invalid_id_part2(123_123_123)
  |> should.be_true()
}

pub fn is_invalid_part2_1212121212_test() {
  day02.is_invalid_id_part2(1_212_121_212)
  |> should.be_true()
}

pub fn is_invalid_part2_1111111_test() {
  day02.is_invalid_id_part2(1_111_111)
  |> should.be_true()
}
...
pub fn parse_range_large_test() {
  ...
  |> should.equal(Ok(#(1_188_511_880, 1_188_511_890)))
}
